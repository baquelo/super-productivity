...
export enum IPC {
  ...
  CLICKUP_CB_EVENT = 'CLICKUP_RESPONSE',
  CLICKUP_MAKE_REQUEST_EVENT = 'CLICKUP',
  CLICKUP_SETUP_IMG_HEADERS = 'CLICKUP_IMAGE_HEADERS',
  ...
  FLASH_PROGRESS_BAR = 'FLASH_PROGRESS_BAR',
