const T = {
  ...
  F: {
    ...
    CLICKUP: {
      BANNER: {
        BLOCK_ACCESS_MSG: 'F.CLICKUP.BANNER.BLOCK_ACCESS_MSG',
        BLOCK_ACCESS_UNBLOCK: 'F.CLICKUP.BANNER.BLOCK_ACCESS_UNBLOCK',
      },
      CFG_CMP: {
        ALWAYS_ASK: 'F.CLICKUP.CFG_CMP.ALWAYS_ASK',
        DONE: 'F.CLICKUP.CFG_CMP.DONE',
        DO_NOT: 'F.CLICKUP.CFG_CMP.DO_NOT',
        ENABLE: 'F.CLICKUP.CFG_CMP.ENABLE',
        ENABLE_TRANSITIONS: 'F.CLICKUP.CFG_CMP.ENABLE_TRANSITIONS',
        IN_PROGRESS: 'F.CLICKUP.CFG_CMP.IN_PROGRESS',
        LOAD_SUGGESTIONS: 'F.CLICKUP.CFG_CMP.LOAD_SUGGESTIONS',
        MAP_CUSTOM_FIELDS: 'F.CLICKUP.CFG_CMP.MAP_CUSTOM_FIELDS',
        MAP_CUSTOM_FIELDS_INFO: 'F.CLICKUP.CFG_CMP.MAP_CUSTOM_FIELDS_INFO',
        OPEN: 'F.CLICKUP.CFG_CMP.OPEN',
        SELECT_ISSUE_FOR_TRANSITIONS: 'F.CLICKUP.CFG_CMP.SELECT_ISSUE_FOR_TRANSITIONS',
        STORY_POINTS: 'F.CLICKUP.CFG_CMP.STORY_POINTS',
      },
      DIALOG_CONFIRM_ASSIGNMENT: {
        MSG: 'F.CLICKUP.DIALOG_CONFIRM_ASSIGNMENT.MSG',
        OK: 'F.CLICKUP.DIALOG_CONFIRM_ASSIGNMENT.OK',
      },
      DIALOG_INITIAL: {
        TITLE: 'F.CLICKUP.DIALOG_INITIAL.TITLE',
      },
      DIALOG_TRANSITION: {
        CHOOSE_STATUS: 'F.CLICKUP.DIALOG_TRANSITION.CHOOSE_STATUS',
        CURRENT_ASSIGNEE: 'F.CLICKUP.DIALOG_TRANSITION.CURRENT_ASSIGNEE',
        CURRENT_STATUS: 'F.CLICKUP.DIALOG_TRANSITION.CURRENT_STATUS',
        TITLE: 'F.CLICKUP.DIALOG_TRANSITION.TITLE',
        UPDATE_STATUS: 'F.CLICKUP.DIALOG_TRANSITION.UPDATE_STATUS',
        TASK_NAME: 'F.CLICKUP.DIALOG_TRANSITION.TASK_NAME',
      },
      DIALOG_WORKLOG: {
        CURRENTLY_LOGGED: 'F.CLICKUP.DIALOG_WORKLOG.CURRENTLY_LOGGED',
        INVALID_DATE: 'F.CLICKUP.DIALOG_WORKLOG.INVALID_DATE',
        SAVE_WORKLOG: 'F.CLICKUP.DIALOG_WORKLOG.SAVE_WORKLOG',
        STARTED: 'F.CLICKUP.DIALOG_WORKLOG.STARTED',
        SUBMIT_WORKLOG_FOR: 'F.CLICKUP.DIALOG_WORKLOG.SUBMIT_WORKLOG_FOR',
        TIME_SPENT: 'F.CLICKUP.DIALOG_WORKLOG.TIME_SPENT',
        TITLE: 'F.CLICKUP.DIALOG_WORKLOG.TITLE',
      },
      FORM: {
        IS_AUTO_ADD_TO_BACKLOG: 'F.CLICKUP.FORM.IS_AUTO_ADD_TO_BACKLOG',
        IS_AUTO_POLL: 'F.CLICKUP.FORM.IS_AUTO_POLL',
        IS_SEARCH_ISSUES_FROM_GITHUB: 'F.CLICKUP.FORM.IS_SEARCH_ISSUES_FROM_GITHUB',
        REPO: 'F.CLICKUP.FORM.REPO',
      },
      FORM_ADV: {
        AUTO_ADD_BACKLOG_JQL_QUERY: 'F.CLICKUP.FORM_ADV.AUTO_ADD_BACKLOG_JQL_QUERY',
        IS_ADD_WORKLOG_ON_SUB_TASK_DONE:
          'F.CLICKUP.FORM_ADV.IS_ADD_WORKLOG_ON_SUB_TASK_DONE',
        IS_AUTO_ADD_TO_BACKLOG: 'F.CLICKUP.FORM_ADV.IS_AUTO_ADD_TO_BACKLOG',
        IS_AUTO_POLL_TICKETS: 'F.CLICKUP.FORM_ADV.IS_AUTO_POLL_TICKETS',
        IS_CHECK_TO_RE_ASSIGN_TICKET_ON_TASK_START:
          'F.CLICKUP.FORM_ADV.IS_CHECK_TO_RE_ASSIGN_TICKET_ON_TASK_START',
        IS_WORKLOG_ENABLED: 'F.CLICKUP.FORM_ADV.IS_WORKLOG_ENABLED',
        SEARCH_JQL_QUERY: 'F.CLICKUP.FORM_ADV.SEARCH_JQL_QUERY',
      },
      FORM_CRED: {
        API_TOKEN: 'F.CLICKUP.FORM_CRED.API_TOKEN',
      },
      FORM_SECTION: {
        ADV_CFG: 'F.CLICKUP.FORM_SECTION.ADV_CFG',
        CREDENTIALS: 'F.CLICKUP.FORM_SECTION.CREDENTIALS',
        HELP_ARR: {
          H1: 'F.CLICKUP.FORM_SECTION.HELP_ARR.H1',
          H2: 'F.CLICKUP.FORM_SECTION.HELP_ARR.H2',
          H3: 'F.CLICKUP.FORM_SECTION.HELP_ARR.H3',
          P1_1: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P1_1',
          P1_2: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P1_2',
          P1_3: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P1_3',
          P1_4: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P1_4',
          P2_1: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P2_1',
          P2_2: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P2_2',
          P2_3: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P2_3',
          P3_1: 'F.CLICKUP.FORM_SECTION.HELP_ARR.P3_1',
        },
      },
      ISSUE_CONTENT: {
        ASSIGNEE: 'F.CLICKUP.ISSUE_CONTENT.ASSIGNEE',
        AT: 'F.CLICKUP.ISSUE_CONTENT.AT',
        ATTACHMENTS: 'F.CLICKUP.ISSUE_CONTENT.ATTACHMENTS',
        CHANGED: 'F.CLICKUP.ISSUE_CONTENT.CHANGED',
        COMMENTS: 'F.CLICKUP.ISSUE_CONTENT.COMMENTS',
        COMPONENTS: 'F.CLICKUP.ISSUE_CONTENT.COMPONENTS',
        DESCRIPTION: 'F.CLICKUP.ISSUE_CONTENT.DESCRIPTION',
        LIST_OF_CHANGES: 'F.CLICKUP.ISSUE_CONTENT.LIST_OF_CHANGES',
        MARK_AS_CHECKED: 'F.CLICKUP.ISSUE_CONTENT.MARK_AS_CHECKED',
        ON: 'F.CLICKUP.ISSUE_CONTENT.ON',
        STATUS: 'F.CLICKUP.ISSUE_CONTENT.STATUS',
        STORY_POINTS: 'F.CLICKUP.ISSUE_CONTENT.STORY_POINTS',
        SUMMARY: 'F.CLICKUP.ISSUE_CONTENT.SUMMARY',
        WORKLOG: 'F.CLICKUP.ISSUE_CONTENT.WORKLOG',
        WRITE_A_COMMENT: 'F.CLICKUP.ISSUE_CONTENT.WRITE_A_COMMENT',
      },
      S: {
        ADDED_WORKLOG_FOR: 'F.CLICKUP.S.ADDED_WORKLOG_FOR',
        EXTENSION_NOT_LOADED: 'F.CLICKUP.S.EXTENSION_NOT_LOADED',
        IMPORTED_MULTIPLE_ISSUES: 'F.CLICKUP.S.IMPORTED_MULTIPLE_ISSUES',
        IMPORTED_SINGLE_ISSUE: 'F.CLICKUP.S.IMPORTED_SINGLE_ISSUE',
        INSUFFICIENT_SETTINGS: 'F.CLICKUP.S.INSUFFICIENT_SETTINGS',
        INVALID_RESPONSE: 'F.CLICKUP.S.INVALID_RESPONSE',
        ISSUE_NO_UPDATE_REQUIRED: 'F.CLICKUP.S.ISSUE_NO_UPDATE_REQUIRED',
        ISSUE_UPDATE: 'F.CLICKUP.S.ISSUE_UPDATE',
        MANUAL_UPDATE_ISSUE_SUCCESS: 'F.CLICKUP.S.MANUAL_UPDATE_ISSUE_SUCCESS',
        MISSING_ISSUE_DATA: 'F.CLICKUP.S.MISSING_ISSUE_DATA',
        NO_AUTO_IMPORT_JQL: 'F.CLICKUP.S.NO_AUTO_IMPORT_JQL',
        NO_VALID_TRANSITION: 'F.CLICKUP.S.NO_VALID_TRANSITION',
        POLLING: 'F.CLICKUP.S.POLLING',
        TIMED_OUT: 'F.CLICKUP.S.TIMED_OUT',
        TRANSITION: 'F.CLICKUP.S.TRANSITION',
        TRANSITIONS_LOADED: 'F.CLICKUP.S.TRANSITIONS_LOADED',
        TRANSITION_SUCCESS: 'F.CLICKUP.S.TRANSITION_SUCCESS',
        UNABLE_TO_REASSIGN: 'F.CLICKUP.S.UNABLE_TO_REASSIGN',
      },
      STEPPER: {
        CREDENTIALS: 'F.CLICKUP.STEPPER.CREDENTIALS',
        DONE: 'F.CLICKUP.STEPPER.DONE',
        LOGIN_SUCCESS: 'F.CLICKUP.STEPPER.LOGIN_SUCCESS',
        TEST_CREDENTIALS: 'F.CLICKUP.STEPPER.TEST_CREDENTIALS',
        WELCOME_USER: 'F.CLICKUP.STEPPER.WELCOME_USER',
      },
    },
    METRIC: {
      BANNER: {
    ...
    PROJECT: {
      D_CREATE: {
        ...
        SETUP_CLICKUP: 'F.PROJECT.D_CREATE.SETUP_CLICKUP',
      },
      FORM_BASIC: {
